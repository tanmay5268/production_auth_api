...
export default function VerificationEmail({
    ...
    return (
        <Html lang="en" dir="ltr">
            ...
            <Preview>Verify your account to get started with AuthAPI</Preview>
            <Body style={main}>
                <Container style={container}>
                    ...
                    <Section style={contentArea}>
                        ...
                        <Text style={bodyText}>
                            Your account is almost ready. Click below to verify your
                            email and secure your access.
                        </Text>
                        ...
                        <Text style={noteText}>
                            ...
                            Did not create this account? You can safely ignore this
                            email.
                        </Text>
...
// Premium Security Stationery palette
const main = {
